...
# plt.plot(new_rri_real_time, new_rri)

fig,ax = plt.subplots(nrows=2, ncols=1)
ax[0].plot(new_rri_time[-2002000:-2000000], new_rri[-2002000:-2000000])
ax[0].set_title("RRI [-2002000:-2000000]")
ax[1].plot(ecg_cleaned[-2002000:-2000000])
ax[1].set_title("ECG [-2002000:-2000000]")
plt.show()
